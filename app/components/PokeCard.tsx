  ...
  return (
    <>
      {pokemon.map((num, index) => {
        ...
        return (
          <div className="w-200px h-400px bg-white hover:bg-gray-100 rounded-xl grid justify-center content-center shadow-xl min-h-full" key={data.id} onClick={() => onClick(data.id)}>
            <div className="text-center">{data.species.name}</div>
